...
/* PM8546 Text generator constants */
...
const testsignal_text_boundaries_t philips4x3_pal_secam_topbox = {
	.first_line = 50,
	.first_sample = 419,
	.height = 42,
	.width = 147,
...
const testsignal_text_boundaries_t philips4x3_pal_secam_bottombox = {
	.first_line = 239,
	.first_sample = 381,
	.height = 42,
	.width = 223,
...
const testsignal_text_boundaries_t philips4x3_pal_secam_date = {
	.first_line = 156,
	.first_sample = 285,
	.height = 40,
	.width = 146,
...
const testsignal_text_boundaries_t philips4x3_pal_secam_time = {
	.first_line = 156,
	.first_sample = 554,
	.height = 40,
	.width = 146,
...
const testsignal_text_boundaries_t philips4x3_ntsc_topbox = {
	.first_line = 45,
	.first_sample = 412,
	.height = 36,
	.width = 143,
...
const testsignal_text_boundaries_t philips4x3_ntsc_bottombox = {
	.first_line = 198,
	.first_sample = 376,
	.height = 36,
	.width = 216,
...
const testsignal_text_boundaries_t philips16x9_pal_topbox = {
	.first_line = 50,
	.first_sample = 438,
	.height = 42,
	.width = 111,
...
const testsignal_text_boundaries_t philips16x9_pal_bottombox = {
	.first_line = 239,
	.first_sample = 409,
	.height = 42,
	.width = 169,
...
const testsignal_text_boundaries_t philips16x9_pal_date = {
	.first_line = 156,
	.first_sample = 338,
	.height = 40,
	.width = 122,
...
const testsignal_text_boundaries_t philips16x9_ntsc_topbox = {
	.first_line = 45,
	.first_sample = 429,
	.height = 36,
	.width = 108,
...
const testsignal_text_boundaries_t philips16x9_ntsc_bottombox = {
	.first_line = 198,
	.first_sample = 401,
	.height = 36,
	.width = 164,
...
const testsignal_text_boundaries_t philips16x9_ntsc_time = {
	.first_line = 131,
	.first_sample = 514,
	.height = 32,
	.width = 119,
...
const testsignal_text_boundaries_t philips16x9_pal_time = {
	.first_line = 156,
	.first_sample = 526,
	.height = 40,
	.width = 122,
...
const testsignal_text_boundaries_t fubk4x3_leftbox = {
	.first_line = 166,
	.first_sample = 362,
	.height = 40,
	.width = 128,
...
const testsignal_text_boundaries_t fubk4x3_rightbox = {
	.first_line = 166,
	.first_sample = 495,
	.height = 40,
	.width = 128,
...
const testsignal_text_boundaries_t fubk4x3_timebox = {
	.first_line = 266,
	.first_sample = 657,
	.height = 38,
	.width = 118,
...
const testsignal_text_boundaries_t fubk4x3_datebox = {
	.first_line = 266,
	.first_sample = 209,
	.height = 38,
	.width = 118,
...
const testsignal_text_boundaries_t fubk16x9_leftbox = {
	.first_line = 166,
	.first_sample = 395,
	.height = 40,
	.width = 96,
...
const testsignal_text_boundaries_t fubk16x9_rightbox = {
	.first_line = 166,
	.first_sample = 494,
	.height = 40,
	.width = 96,
...
const testsignal_text_boundaries_t fubk16x9_timebox = {
	.first_line = 266,
	.first_sample = 617,
	.height = 38,
	.width = 118,
...
const testsignal_text_boundaries_t fubk16x9_datebox = {
	.first_line = 266,
	.first_sample = 253,
	.height = 38,
	.width = 118,
...
const testsignal_params_t philips4x3_pal = {
...
const testsignal_params_t philips4x3_secam = {
...
const testsignal_params_t philips4x3_secam_time = {
...
const testsignal_params_t philips4x3_secam_date_time = {
...
const testsignal_params_t philips4x3_ntsc = {
...
const testsignal_params_t philips16x9_pal = {
...
const testsignal_params_t philips16x9_ntsc = {
...
const testsignal_params_t fubk4x3 = {
...
const testsignal_params_t fubk4x3_time = {
...
const testsignal_params_t fubk4x3_date_time = {
...
const testsignal_params_t philips_indian_head = {
...
const testsignal_params_t fubk16x9_pal = {
...
const testsignal_params_t fubk16x9_pal_time = {
...
const testsignal_params_t fubk16x9_pal_date_time = {
...
const testsignal_params_t ebu_cbar_pal = {
...
const testsignal_params_t smtpe_cbar_ntsc = {
...
const testsignal_params_t pulse_bar_pal = {
...
const testsignal_params_t sin_x_x_pal = {
...
static int _testsignal_pm8546_skey_filter_process(pm8546_skey_filter_t* filter, int16_t* samples, int nsamples)
{
...
static void _testsignal_pm8546_copy_half_char(testsignal_t* tc, uint8_t* rom, int dest_idx, int src_idx)
{
...
static void _testsignal_pm8546_text_unfold(testsignal_t* tc, uint8_t* rom)
{
	...
	_testsignal_pm8546_copy_half_char(tc, rom, PM8546_CHAR_INDEX('{'), PM8546_CHAR_INDEX(':')); /* Half colon */
	_testsignal_pm8546_copy_half_char(tc, rom, PM8546_CHAR_INDEX('|'), PM8546_CHAR_INDEX('-')); /* Half dash */
}

static int _testsignal_pm8546_text_calculate_flanks(testsignal_t* tc, pm8546_skey_filter_t* filter)
{
	int i, y, r = VID_OK;
	...
	for (i = 0; i < sizeof(_char_blocks) / sizeof(pm8546_promblock_t); i++)
	{
		...
		for (y = 0; y < PM8546_BLOCK_HEIGHT; y++)
		{
			...
			r = _testsignal_pm8546_skey_filter_process(filter, &tc->text_samples[line_start], line_len);
...
static int _testsignal_pm8546_text_downsample(testsignal_t* tc)
{
	int i, y;
...
static int _testsignal_clone_box(testsignal_t* tc, const testsignal_text_boundaries_t* box, int16_t **orig_r)
{
	int f, y, x;
...
static void _testsignal_restore_box(testsignal_t* tc, const testsignal_text_boundaries_t* box, int16_t* orig, int level)
{
	int f, y, x;
...
static int16_t _testsignal_calc_hacktv_level(testsignal_t* tc, const int16_t level)
{
	...
	for (f = 0; f < tc->params->num_frames; f++)
	{
		...
		if (tc->params->is_philips_16x9 && tc->params->num_lines == 625)
		{
			...
			if (box == &philips16x9_pal_date)
			{
				...
				{
					tc->samples[linef1_start + 462 + i] = _testsignal_calc_hacktv_level(tc, curve[i]);
					tc->samples[linef2_start + 462 + i] = _testsignal_calc_hacktv_level(tc, curve[i]);
				}
			}
			if (box == &philips16x9_pal_time)
			{
				for (int i = 0; i < (sizeof(curve) / sizeof(int16_t)); i++)
				{
					tc->samples[linef1_start + 521 + i] = _testsignal_calc_hacktv_level(tc, curve[((sizeof(curve) / sizeof(int16_t)) - 1) - i]);
					tc->samples[linef2_start + 521 + i] = _testsignal_calc_hacktv_level(tc, curve[((sizeof(curve) / sizeof(int16_t)) - 1) - i]);
				}
			}
		}
		...
		if (tc->params->is_philips_16x9 && tc->params->num_lines == 525)
		{
			...
			if (box == &philips16x9_ntsc_date)
			{
				for (int i = 0; i < (sizeof(curve) / sizeof(int16_t)); i++)
				{
					tc->samples[linef1_start + 452 + i] = _testsignal_calc_hacktv_level(tc, curve[i]);
					tc->samples[linef2_start + 452 + i] = _testsignal_calc_hacktv_level(tc, curve[i]);
				}
			}
			if (box == &philips16x9_ntsc_time)
			{
				for (int i = 0; i < (sizeof(curve) / sizeof(int16_t)); i++)
				{
					tc->samples[linef1_start + 508 + i] = _testsignal_calc_hacktv_level(tc, curve[((sizeof(curve) / sizeof(int16_t)) - 1) - i]);
					tc->samples[linef2_start + 508 + i] = _testsignal_calc_hacktv_level(tc, curve[((sizeof(curve) / sizeof(int16_t)) - 1) - i]);
				}
			}
		}
	}
...
static void _testsignal_write_text(testsignal_t* tc, const testsignal_text_boundaries_t* box, const char *text, int black_level)
{
...
static void _testsignal_text_process(testsignal_t* tc)
{
	time_t rawtime;
	struct tm *info;
	char time_buf[64];
	...
	{
		_testsignal_restore_box(tc, tc->params->text1_box, tc->text1_orig, 0);
		_testsignal_write_text(tc, tc->params->text1_box, tc->conf.text1, tc->text1_black_level);
	}

	if (tc->params->text2_box && tc->conf.text2[0])
	{
		_testsignal_restore_box(tc, tc->params->text2_box, tc->text2_orig, 0);
	 	_testsignal_write_text(tc, tc->params->text2_box, tc->conf.text2, tc->text2_black_level);
	}

	if (tc->params->time_box && (tc->conf.clock_mode == TESTSIGNAL_CLOCK_TIME || tc->conf.clock_mode == TESTSIGNAL_CLOCK_DATE_TIME))
	{
		_testsignal_restore_box(tc, tc->params->time_box, tc->time_orig, 0);
		_testsignal_write_text(tc, tc->params->time_box, time_buf, tc->time_black_level);
	}

	if (tc->params->date_box && tc->conf.clock_mode == TESTSIGNAL_CLOCK_DATE_TIME)
	{
		_testsignal_restore_box(tc, tc->params->date_box, tc->date_orig, 0);
		_testsignal_write_text(tc, tc->params->date_box, date_buf, tc->date_black_level);
	}
}

int testsignal_next_line(vid_t *s, void *arg, int nlines, vid_line_t **lines)
{
...
static int _testsignal_configure(testsignal_t* tc, vid_t *vid)
{
	...
	switch (vid->conf.testsignal_philips_type)
	{
		case TESTSIGNAL_PHILIPS_4X3:
			...
			{
				switch (vid->conf.testsignal_clock_mode)
				{
					case TESTSIGNAL_CLOCK_OFF:
						params = &philips4x3_secam;
						break;
					case TESTSIGNAL_CLOCK_TIME:
						params = &philips4x3_secam_time;
						break;
					case TESTSIGNAL_CLOCK_DATE_TIME:
						params = &philips4x3_secam_date_time;
						break;
				}
			}
			break;
		case TESTSIGNAL_PHILIPS_16X9:
			if (vid->conf.colour_mode == VID_PAL)
			{
		...
		case TESTSIGNAL_FUBK_16X9:
			...
			break;
		case TESTSIGNAL_PHILIPS_INDIAN_HEAD:
			if (vid->conf.colour_mode == VID_PAL)
			{
				params = &philips_indian_head;
			}
			break;
		case TESTSIGNAL_CBAR:
			if (vid->conf.colour_mode == VID_PAL)
			{
				params = &ebu_cbar_pal;
			}
			...
			break;
		case TESTSIGNAL_PULSE_AND_BAR:
			if (vid->conf.colour_mode == VID_PAL)
			{
				params = &pulse_bar_pal;
			}
			break;
		case TESTSIGNAL_SIN_X_X:
			if (vid->conf.colour_mode == VID_PAL)
			{
				params = &sin_x_x_pal;
			}
	...
	if (!params)
	{
		fprintf(stderr, "testsignal: No testsignal for this mode\n");
		return(VID_ERROR);
	}

	if (params->sample_rate != vid->pixel_rate)
	{
		fprintf(stderr, "testsignal: pixel rate must be set to %lu\n", params->sample_rate);
		return(VID_ERROR);
	}
	...
	if (params->text1_box)
		tc->text1_black_level = _testsignal_calc_hacktv_level(tc, params->text1_box->black_level);

	if (params->text2_box)
		tc->text2_black_level = _testsignal_calc_hacktv_level(tc, params->text1_box->black_level);

	if (params->time_box)
		tc->time_black_level = _testsignal_calc_hacktv_level(tc, params->time_box->black_level);

	if (params->date_box)
		tc->date_black_level = _testsignal_calc_hacktv_level(tc, params->date_box->black_level);
...
static int _testsignal_pm8546_rom_load(testsignal_t* tc, uint8_t** buf)
{
	...
	if (file_len != 0x8000)
	{
		fprintf(stderr, "testsignal: PM8546 character set PROM size incorrect\n");
		fclose(f);
		return(VID_ERROR);
	}
...
int _testsignal_pm8546_text_init(testsignal_t* tc)
{
	int r = VID_OK;
	uint8_t* buf;
	...
	r = _testsignal_pm8546_rom_load(tc, &buf);
	 ...
	 */
	_testsignal_pm8546_text_unfold(tc, buf);

	free(buf); /* Free contents of PROM. No longer needed. */

	/* Init filter */
	_testsignal_pm8546_skey_filter_init(&skey, tc->black_level);
	 ...
	 */
	r = _testsignal_pm8546_text_calculate_flanks(tc, &skey);
	 ...
	 */
	r = _testsignal_pm8546_text_downsample(tc);
...
void testsignal_free(testsignal_t *tc)
{
	if (tc->text1_orig)
		free(tc->text1_orig);
...
int testsignal_open(vid_t *s)
{
	testsignal_t *tc = calloc(1, sizeof(testsignal_t));
	int r = VID_OK;
	...
	if (tc->params->text1_box && tc->params->can_blank)
		_testsignal_restore_box(tc, tc->params->text1_box, NULL, tc->text1_black_level);

	if (tc->params->text2_box && tc->params->can_blank)
		_testsignal_restore_box(tc, tc->params->text2_box, NULL, tc->text2_black_level);
	...
	{
		r = _testsignal_clone_box(tc, tc->params->text1_box, &tc->text1_orig);
	...
	{
		r = _testsignal_clone_box(tc, tc->params->text2_box, &tc->text2_orig);
	...
	{
		r = _testsignal_clone_box(tc, tc->params->time_box, &tc->time_orig);
	...
	{
		r = _testsignal_clone_box(tc, tc->params->date_box, &tc->date_orig);
	...
	r = _testsignal_pm8546_text_init(tc);
...
testsignal_type_t testsignal_type(const char *s)
{
	if (!strcmp(s, "philips4x3"))
		return TESTSIGNAL_PHILIPS_4X3;
	if (!strcmp(s, "philips16x9"))
		return TESTSIGNAL_PHILIPS_16X9;
	if (!strcmp(s, "fubk4x3"))
		return TESTSIGNAL_FUBK_4X3;
	if (!strcmp(s, "fubk16x9"))
		return TESTSIGNAL_FUBK_16X9;
	if (!strcmp(s, "philipsih"))
		return TESTSIGNAL_PHILIPS_INDIAN_HEAD;
	if (!strcmp(s, "cbar"))
		return TESTSIGNAL_CBAR;
	if (!strcmp(s, "pulseandbar"))
		return TESTSIGNAL_PULSE_AND_BAR;
	if (!strcmp(s, "sinxx"))
		return TESTSIGNAL_SIN_X_X;
	
	return -1;
}

testsignal_clock_mode_t testsignal_clock_mode(const char *s)
{
	if (!strcmp(s, "time"))
		return TESTSIGNAL_CLOCK_TIME;
	if (!strcmp(s, "datetime"))
		return TESTSIGNAL_CLOCK_DATE_TIME;

	return TESTSIGNAL_CLOCK_OFF;
}